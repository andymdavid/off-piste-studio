...
<head>
  ...
  <link rel="stylesheet" href="/src/styles/main.css?v=20260616-insights-pathway-layout">
  ${fontsHtml}
</head>
<body data-page-type="industry" data-page-slug="${escapeHtml(page.slug)}">
  ...
  ${footerHtml}
  <script type="module" src="/src/js/main.js?v=20260616-insights-pathway-layout"></script>
</body>
</html>`;
}
