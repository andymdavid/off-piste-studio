...
${post.image ? `        "image": "https://offpistestudio.com${escapeHtml(post.image)}",\n` : ''}\
  ...
  <link rel="stylesheet" href="/src/styles/main.css?v=20260608-footer-override">
