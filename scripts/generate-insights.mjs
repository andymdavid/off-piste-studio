...
${post.image ? `        "image": "https://offpistestudio.com${escapeHtml(post.image)}",\n` : ''}\
  ...
  <link rel="stylesheet" href="/src/styles/main.css?v=20260616-insights-square-grid">
...
${footerHtml}
  <script type="module" src="/src/js/main.js?v=20260616-insights-square-grid"></script>
</body>
</html>
`;
}
